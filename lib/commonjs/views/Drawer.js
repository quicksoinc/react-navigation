...
class DrawerView extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(_GestureHandler.PanGestureHandler, _extends({
      ...
      failOffsetY: [-SWIPE_DISTANCE_MINIMUM, SWIPE_DISTANCE_MINIMUM] // onGestureEvent={this.handleGestureEvent}
    ...
    drawerType === 'permanent' ? null : _reactNative.Platform.OS === 'web' || _reactNative.Platform.OS === 'windows' || _reactNative.Platform.OS === 'macos' ? /*#__PURE__*/React.createElement(_reactNative.TouchableWithoutFeedback, {
      ...
      enabled: gestureEnabled // onHandlerStateChange={this.handleTapStateChange}
      ,
      onHandlerStateChange: ({
        nativeEvent
      }) => {
        if (nativeEvent.oldState === _GestureHandler.GestureState.ACTIVE) {
